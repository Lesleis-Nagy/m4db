...
def test_set_model_quants(client):
    ...
    response = client.simulate_post("/set-model-quants", json=json.dumps(response_data.to_primitive()))
...
def test_set_model_quants_noexist(client):
